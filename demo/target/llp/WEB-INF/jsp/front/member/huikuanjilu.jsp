...
<div class="x_panel">
	...
	<div class="x_content">
		...
		<c:if test="${empty repayment_records }">
			<div
				...
				<img src="${pageContext.request.contextPath}/images/nondata.png"
					width="60" height="60"><br> <br> 暂无回款记录
			</div>
		</c:if>
		...
		<script type="text/javascript">
			//分页
			function page(num) {
				window.location.href = "repayment_record?currentPageNo=" + num+"&status=yh&payee_user_id="+${session_user.id};
			}
		</script>
	</div>
</div>
