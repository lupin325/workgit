...
<script type="text/javascript">
	function repay(num) {
		if (num == 1) {
			window.location.href = "${pageContext.request.contextPath}/front/member/repayment_record?status=wh&payee_user_id="+${session_user.id};
		}
		if (num == 2) {
			window.location.href = "${pageContext.request.contextPath}/front/member/repayment_record?status=yh&payee_user_id="+${session_user.id};
		}
		if (num == 3) {
			window.location.href = "${pageContext.request.contextPath}/front/member/repayment_record?status=wh&payer_user_id="+${session_user.id};
		}
		if (num == 4) {
			window.location.href = "${pageContext.request.contextPath}/front/member/repayment_record?status=yh&payer_user_id="+${session_user.id};
		}
	}
</script>