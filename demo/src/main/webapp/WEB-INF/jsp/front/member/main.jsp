...
<div class="pmain-profile">
	<div class="pmain-welcome">
		<c:if test="${now.hours<12 }">
			<span class="fl"><span id="outLogin">早上好，</span>${session_user.username}
				喝一杯奶茶茶，让心情放松一下~</span>
		</c:if>
		<c:if test="${now.hours>12 and now.hours<20}">
			<span class="fl"><span id="outLogin">下午好，</span>${session_user.username}
				喝一杯下午茶，让心情放松一下~</span>
		</c:if>
		<c:if test="${now.hours>20}">
			<span class="fl"><span id="outLogin">晚上好，</span>${session_user.username}
				喝一杯咖啡茶，精神一下~</span>
		</c:if>
